...
@section('title',"African Health Savers| Contact Us")
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="contact-gmap">
                        <iframe width="600" height="450" frameborder="0" style="border:0" src="https://maps.google.com/maps?q=Ibadan%20%2C%20Oyo%20state%20Nigeria&t=&z=13&ie=UTF8&iwloc=&output=embed" allowfullscreen></iframe>
                    </div>
                </div>
            </div><!-- .row -->
        </div><!-- .container -->
