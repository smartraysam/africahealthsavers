...
@section('title',"African Health Savers| Our Causes")
@section('content')
                    ...
                    <div class="cause-wrap d-flex flex-wrap justify-content-between">
                        ...
                        <div class="cause-content-wrap">
                            <header class="entry-header d-flex flex-wrap align-items-center">
                                <h3 class="entry-title w-100 m-0"><a href="/single-causes">Fundraiser for Kids</a></h3>
                ...
                <div class="col-12 col-lg-6">
                    <div class="cause-wrap d-flex flex-wrap justify-content-between">
                        ...
                        <div class="cause-content-wrap">
                            ...
                            <div class="entry-footer mt-5">
                                <a href="/give" class="btn gradient-bg mr-2">Donate Now</a>
                            </div><!-- .entry-footer -->
                        </div><!-- .cause-content-wrap -->
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        ...
                        <div class="cause-content-wrap">
                            <header class="entry-header d-flex flex-wrap align-items-center">
                                <h3 class="entry-title w-100 m-0"><a href="/single-causes">Bring water to the childrens</a></h3>
                            </header><!-- .entry-header -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="cause-wrap">
                        ...
                        <div class="cause-content-wrap">
                            <header class="entry-header d-flex flex-wrap align-items-center">
                                <h3 class="entry-title w-100 m-0"><a href="/single-causes">Education for all</a></h3>
                            </header><!-- .entry-header -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 order-2 order-lg-1">
                    ...
                    <div class="entry-footer mt-5">
                        <a href="/give" class="btn gradient-bg">Donate Now</a>
                    </div><!-- .entry-footer -->
                </div><!-- .col -->
