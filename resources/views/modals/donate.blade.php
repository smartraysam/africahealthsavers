    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="" enctype="multipart/form-data" id="donate">
                    <div class="donate">
                        <div class="container">
                            <div class="donate-main">
                                <div class="col-md-8 donate-left">

                                    <h3>Make a difference </h3>
                                    <p>A little can make a different.</p>
                                </div>
                                <div class="col-md-12 donate-right">
                                    <div class="donate-top">
                                        ...
                                        <div class="radio-bot">
                                            ...
                                            <a class="search" href="#"> <input type="text" value="$ Other"
                                                    onfocus="this.value = '';"
                                                    onblur="if (this.value == '') {this.value = '$ Other';}"> </a>
                                        </div>
                                        <p>first true generator on the Internet. It uses a dictionary of over 200 Latin
                                        </p>
                                    </div>
                                    <div class="donate-top">
                                        ...
                                        <form>
                                            ...
                                            <input type="text" value="Email Address*" onfocus="this.value = '';"
                                            ...
                                            <div class="text-sma">
                                                ...
                                                <input type="text" value="Zip*" onfocus="this.value = '';"
...
<div class="modal fade" id="modal-donate" role="dialog">
